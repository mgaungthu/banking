    ...
    <View
      ...
      {showBack ? (
        <TouchableOpacity
          ...
          style={isDarkTheme(appTheme) ? commonStyles.backBtnDark : commonStyles.backBtn
        }>
          <Icon
      ...
      {currency ? currencyComponent :
        <View
          style={{ marginLeft: rightComponentWidth > 0 ? rightComponentWidth - 40 : 0 }}
        >
          {isImg && (
            <Image
              source={imgUrl}
              resizeMode='contain'
              style={imgStyle || { height: 30, width: 30, marginTop: isIOS() ? -10 : 0, }}
            />
          )}
          <Text
            style={[
