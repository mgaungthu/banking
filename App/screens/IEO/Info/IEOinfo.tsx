...
const IEOinfo = (props: any) => {
  ...
  useEffect(() => {
    dispatch(IeoActions.getIeoDetails(id));
  }, []);
  ...
  if (ticker?.allowedCurrency) {
    allowed_currency = ticker?.allowedCurrency.split(',').map(symbol => (
      <View key={symbol} style={[styles.iconImageContainer]}>
        ...
        />
        <ThemeText style={styles.iconImageText}>{symbol}</ThemeText>
      </View>
    ));
  }
    ...
    <View>
      ...
      {isLoading || !ticker ? (
        ...
        <ScrollView
          ...
          <View
            style={[styles.heading, isRtlApproach ? rtlStyles.reverseRow : {}]}>
            <View
              style={[
                styles.headingLeftContainer,
              ...
              <View
                style={[
                  styles.headingTokenInfo,
                  isRtlApproach ? {marginRight: 10} : {marginLeft: 10},
                ]}>
                <Text
                  numberOfLines={1}
            ...
            <View style={[styles.headingRightContainer]}>
              <View
                style={[
                  styles.audits,
                  isRtlApproach ? rtlStyles.alignSelfStart : {},
                ]}>
            ...
            <View style={styles.textContainer}>
              <View
                ...
                <Text
                  ...
                  {FormatDateTime(new Date(ticker?.startDate))}
                </Text>
              </View>
              <View
                style={[
                ...
                <Text
                  style={[styles.text, ThemeFunctions.getTextColor(appTheme)]}>
                  {FormatDateTime(new Date(ticker?.endDate))}
                </Text>
              </View>
              <View
                style={[
          ...
          <View style={[styles.block, ThemeFunctions.setIEOCardBG(appTheme)]}>
            ...
            <View style={[styles.iconContainer]}>{allowed_currency}</View>
          </View>
          <View style={[styles.block, ThemeFunctions.setIEOCardBG(appTheme)]}>
            <View
              style={[
