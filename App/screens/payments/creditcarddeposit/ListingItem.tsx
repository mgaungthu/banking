      ...
      <View style={reverseDirection()}>
        ...
        <View style={rightAlignView()}>
          <ThemeText
            ...
            adjustsFontSizeToFit={true}
            numberOfLines={2}>
            {AppFunctions.RemoveExpo(trade.feePercentage) || 'N/A'}
          </ThemeText>
        </View>
      </View>
      <View style={reverseDirection()}>
        ...
        <ThemeText
            ...
            adjustsFontSizeToFit={true}
            numberOfLines={2}>
            {AppFunctions.RemoveExpo(trade.feeAmount) || 'N/A'}
          </ThemeText>
        </View>
      </View>
      <View style={reverseDirection()}>
        ...
        <View style={rightAlignView()}>
          <ThemeText
            ...
            adjustsFontSizeToFit={true}
            numberOfLines={2}>
            {AppFunctions.RemoveExpo(trade.amountCredited) || 'N/A'}
          </ThemeText>
        </View>
      </View>
      <View style={reverseDirection()}>
        ...
        <View style={rightAlignView()}>
          <ThemeText
            ...
            adjustsFontSizeToFit={true}
            numberOfLines={2}>
            {AppFunctions.RemoveExpo(trade.cardCurrencyAmount) || 'N/A'}
          </ThemeText>
        </View>
      </View>
