...
import { IeoActions, QuickBuyActions } from '../../../store'
...
import { ieoDetailsSelector, ieoRateSelector, ieoSelector } from '../../../store/selectors/ieoSelector'
...
export default () => {
  ...
  useEffect(() => {
    ...
    dispatch(IeoActions.getIeoRate(id));
  ...
  const _exchange = async () => {
    ...
    if (amountFirstCurrency && amountSecondCurrency) {
      ...
      if (response.status === 200) {
        ...
        dispatch(IeoActions.getIeoHistory(details?.ticker));
