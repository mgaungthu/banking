...
const SelectType = ({
  ...
  return (
    <CustomModal visibility={isVisible} style={[styles.typemodals, ThemeFunctions.setBackground(appTheme)]}>
      <View>
        <View
          style={[styles.header, isRtlApproach ? rtlStyles.reverseRow : {}]}>
          <View style={{width: 10}} />
          <ThemeText
            style={[styles.headerText, { color: ThemeFunctions.customText(appTheme) }]}
        ...
        <FlatList
          data={AppConstants.DepositTypes}
